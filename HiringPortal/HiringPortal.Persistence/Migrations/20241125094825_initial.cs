        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requisitions_Employees_ReviewerId",
                        column: x => x.ReviewerId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requisitions_RequisitionStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "RequisitionStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requisitions_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Jobs_EmployeeTypes_EmploymentTypeId",
                        column: x => x.EmploymentTypeId,
                        principalTable: "EmployeeTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Jobs_Employees_CreatedByEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobApplications_Employees_CreatedByEmployeeId",
                        column: x => x.CreatedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobSkills_SkillSets_SkillId",
                        column: x => x.SkillId,
                        principalTable: "SkillSets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobInterviews_InterviewStatuses_InterviewStatusId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobInterviews_Stages_StageId",
                        column: x => x.StageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_CreatedByEmployeeId",
                table: "JobApplications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobInterviews_InterviewStatusId",
                table: "JobInterviews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobInterviews_StageId",
                table: "JobInterviews",
                column: "StageId");

            migrationBuilder.CreateIndex(
                name: "IX_Jobs_CreatedByEmployeeId",
                table: "Jobs",
                column: "CreatedByEmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requisitions_ReviewerId",
                table: "Requisitions",
                column: "ReviewerId");

            migrationBuilder.CreateIndex(
                name: "IX_Requisitions_RoleId",
                table: "Requisitions",
                column: "RoleId");
